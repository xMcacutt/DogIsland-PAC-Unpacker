...
namespace DogIsland_PAC_Unpacker
{
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            {
                Console.Clear();
                Console.WriteLine("PAC Extractor for The DOG Island");
                ...
                {
                    Console.WriteLine("Would you like to extract ALL .pacs?   Y / N");
                    input = Console.ReadLine();
                }
        ...
        public static void Extract(string path)
        {
            ...
            string outDirPath = Path.Combine(inDirPath, pacName + "pac");
        ...
        {
            foreach (var f in Directory.GetFiles(dirPath, "*.pac", SearchOption.AllDirectories))
            {
                Extract(f);
            }
        }
